...
public class HomeWork4 {
    ...
    public static HashMap<String, Integer> magSort(HashMap<String, Integer> shopCart) {
        ...
        HashMap<String, Integer> by = new HashMap<>();
        HashMap<String, Integer> notBy = new HashMap<>();
        System.out.println(notBy);
        for(HashMap.Entry<String, Integer> entry : notBy.entrySet()) {
            if (entry.getValue() == 2) by.put(entry.getKey(), entry.getValue());
        }
